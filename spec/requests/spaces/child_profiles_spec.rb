...
RSpec.describe "/spaces/:space_id/child_profiles", type: :request do
  ...
  describe "GET /show" do
    ...
    it "renders the child profile as the Support Guide without raw narrative or internal analysis copy" do
      ...
      expect(response.body).to include("Anchor Onboarding Profile completed today")
      ...
      expect(response.body).not_to include("Well-established")
      expect(response.body).not_to include("Profile updated")
